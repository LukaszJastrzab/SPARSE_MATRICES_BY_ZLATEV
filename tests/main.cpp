...
TEST( non_singular_linear_equation_real_float, LU_decomposition_fillin_min )
{
	...
	// this is done using Gauss elimination with picotal strategy
	// ===============================================================
	EXPECT_NO_THROW( DSS->LU_decomposition( PIVOTAL_STRATEGY::FILLIN_MINIMALIZATION, mx_size, 1.0, numeric_limits< float >::min(), true ) );
...
TEST( non_singular_linear_equation_real_float, LU_decomposition_one_row_search )
{
	const size_t mx_size = 50;

	// Input Store Scheme
	// ==================
	auto ISS = generate_ISS< float >( mx_size, mx_size, true, 1, 0.01, 100.0 );
	...
	// this is done using Gauss elimination with picotal strategy
	// ===============================================================
	EXPECT_NO_THROW( DSS->LU_decomposition( PIVOTAL_STRATEGY::ONE_ROW_SEARCHING, mx_size, 1.0, numeric_limits< float >::min(), true ) );
...
TEST( non_singular_linear_equation_real_double, LU_decomposition_one_row_search )
{
	const size_t mx_size = 50;
...
TEST( non_singular_linear_equation_complex_float, LU_decomposition_one_row_search )
{
	const size_t mx_size = 50;
...
TEST( non_singular_linear_equation_complex_double, LU_decomposition_one_row_search )
{
	const size_t mx_size = 50;
